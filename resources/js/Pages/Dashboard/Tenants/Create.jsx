...
export default function Create() {
    ...
    const handleNameChange = (e) => {
        ...
        setData((prev) => ({
            ...
            domain: prev.domain
                ? prev.domain
                : `${val.toLowerCase().replace(/[^a-z0-9]+/g, "")}.localhost`,
        }));
    };
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div className="space-y-6 lg:col-span-2">
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div>
                                        ...
                                        <p className="mt-1 text-[11px] text-slate-400">
                                            Digunakan sebagai subdomain unik (hanya huruf, angka,
                                            dash).
                                        </p>
                                        {errors.id && (
                                            <p className="mt-1 text-xs text-danger-500">
                        ...
                        <div className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            <button
                                ...
                                className="flex w-full items-center justify-between border-b border-slate-100 bg-slate-50/50 px-6 py-4 transition-colors hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-950/20 dark:hover:bg-slate-950/50"
                            >
                                <span className="text-slate-850 flex items-center gap-2 text-base font-bold dark:text-slate-200">
                                    <IconDatabase size={20} className="text-primary-500" />
                                    Konfigurasi Database Kustom (Opsional)
                                </span>
                                <span className="rounded-full bg-primary-50 px-2.5 py-1 text-xs font-semibold text-primary-500 dark:bg-primary-950/40">
                            ...
                            {showDbConfig && (
                                <div className="space-y-4 p-6">
                                    <div className="text-sky-850 flex items-start gap-2.5 rounded-lg border border-sky-100 bg-sky-50 p-3.5 text-xs dark:border-sky-900/50 dark:bg-sky-950/20 dark:text-sky-300">
                                        <IconInfoCircle
                                            size={18}
                                            className="mt-0.5 flex-shrink-0"
                                        />
                                        <p className="leading-relaxed">
                                            Secara default, sistem akan otomatis membuat database
                                            dengan format nama{" "}
                                            <code className="font-bold text-sky-900 dark:text-sky-400">
                                                pos_tenant_[id_tenant]
                                            </code>{" "}
                                            pada host landlord database. Isi bidang di bawah ini
                                            hanya jika Anda ingin mengarahkan tenant ke server
                                            database eksternal terpisah.
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-lg border border-slate-200 px-3.5 py-2.5 text-sm focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-200"
                    ...
                    <div className="space-y-6">
                        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                            <h3 className="text-slate-850 mb-4 border-b border-slate-100 pb-3 text-base font-bold dark:border-slate-800 dark:text-slate-200">
                                Status Pembuatan
                            </h3>
                            ...
                            <div className="space-y-3.5 text-xs leading-relaxed text-slate-500 dark:text-slate-400">
                                <p>
                                    ...
                                    Menekan tombol Simpan akan otomatis memicu:
                                </p>
                                <ul className="list-inside list-disc space-y-1.5 pl-1 font-medium">
                                ...
                                <p className="rounded border border-slate-100 bg-slate-50 p-2.5 font-mono text-[11px] dark:border-slate-800 dark:bg-slate-950/40">
                                    Proses pembuatan dapat memakan waktu 5-15 detik. Mohon jangan
                                    menutup halaman ini saat sedang diproses.
                                </p>
                            </div>
                            ...
                            <div className="mt-6 border-t border-slate-100 pt-6 dark:border-slate-800">
                                ...
                                >
                                    ...
                                    <span>
                                        {processing ? "Membuat Tenant..." : "Daftarkan Tenant"}
                                    </span>
                                </button>
                            </div>
                        </div>

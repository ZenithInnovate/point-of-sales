...
export default function Show({ order }) {
    ...
    const placeOrder = () => {
        router.post(
            route("purchase-orders.place", order.id),
            {},
            {
                preserveScroll: true,
            ...
            <div className="mb-6">
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        ...
                        {order.ordered_at && (
                            <p className="text-sm text-slate-500">
                                Dipesan: {formatDateTime(order.ordered_at)}
                            </p>
                        )}
                    </div>
                    <div className="flex gap-2">
                        ...
                        {canCreateReceiving &&
                            ["ordered", "partial_received"].includes(order.status) && (
                                <Button
                                    type="link"
                                    ...
                                    order.items.map((item) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <Table.Td>
                                                    <span
                                                        className={`font-semibold ${remaining > 0 ? "text-warning-600" : "text-success-600"}`}
                                                    >
                                                        {remaining}
                                                    </span>
                                                </Table.Td>
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-slate-800 dark:text-slate-200">
                                        {order.payable.document_number}
                                    </span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-slate-500">Total</span>
                                    <span className="font-medium text-slate-800 dark:text-slate-200">
                                        {formatCurrency(order.payable.total)}
                                    </span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-slate-500">Dibayar</span>
                                    <span className="font-medium text-slate-800 dark:text-slate-200">
                                        {formatCurrency(order.payable.paid)}
                                    </span>
                                </div>
                                <Link
                        ...
                        <div className="space-y-3 text-sm text-slate-500 dark:text-slate-400">
                            <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800">
                                ...
                                <ul className="mt-2 space-y-2">
                                    ...
                                    <li>
                                        2. Pesan ke supplier untuk mengubah status menjadi Ordered.
                                    </li>

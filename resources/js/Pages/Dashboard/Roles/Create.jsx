        ...
        <>
            ...
            <div className="mb-6">
                ...
                <div className="mt-3 flex items-center gap-3">
                    <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-primary-100 text-primary-600 dark:bg-primary-950/50 dark:text-primary-400">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            Buat group akses baru dan tetapkan daftar kewenangan hak aksesnya.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                        Pilih hak akses di bawah ini. Anda dapat mencentang per elemen atau mengklik "Pilih Semua" pada tiap modul.
                    </p>
                </div>

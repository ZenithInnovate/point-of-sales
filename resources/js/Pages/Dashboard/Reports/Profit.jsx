...
const ProfitReport = ({ transactions, summary, filters, cashiers, customers }) => {
                            ...
                            <div className="mt-4 flex justify-end gap-2">
                                {hasActiveFilters && (
                                    <button
                                        ...
                                        className="rounded-xl border border-slate-200 px-4 py-2.5 text-slate-600 transition-colors hover:bg-slate-100 dark:border-slate-700 dark:text-slate-400"
                                    >
                                        <IconX size={18} />
                                    </button>
                                )}
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-slate-100 dark:border-slate-800">
                                        ...
                                        <th className="px-4 py-4 text-center text-xs font-semibold uppercase text-slate-500">
                                            Item
                                        </th>
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-2 gap-2 text-sm text-slate-600 dark:text-slate-300">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-medium">{trx.total_items ?? 0}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
